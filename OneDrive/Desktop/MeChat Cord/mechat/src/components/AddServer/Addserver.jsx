...
import { DialogActions, DialogContent, DialogContentText,makeStyles, Typography } from '@mui/material';
...
function Addserver() {
    ...
    const handleClickOpen = () => {
      ...
      const handleSubmit=async (e)=>{
        ...
        setformValue('');
        if(serverid && generalid) navigate.push(`/discord-clone/channels/${serverid}/${generalid}`)
      }
